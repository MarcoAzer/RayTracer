...
public:
	...
	MeshConsolidator(std::initializer_list<ObjFilePath>  objFileList, bool addUV=true );
    ...
    std::vector<glm::vec3> getVertexPositionData() const;
    std::vector<glm::vec2> getVertexUVData() const;
